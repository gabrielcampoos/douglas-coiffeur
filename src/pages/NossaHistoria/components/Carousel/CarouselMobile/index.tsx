	...
	return (
		<div>
			...
			>
				...
				{/* <div style={{ background: '#133337' }}>slide 3</div>
				<div style={{ background: '#ffc0cb' }}>slide 4</div>
				<div style={{ background: '#ffffff' }}>slide 5</div>
				<div style={{ background: '#ffe4e1' }}>slide 6</div>
				<div style={{ background: '#008080' }}>slide 7</div>
				<div style={{ background: '#ff0000' }}>slide 8</div>
				<div style={{ background: '#e6e6fa' }}>slide 9</div> */}
			</ReactSimplyCarousel>
		</div>
		// <Container
		// 	sx={{
